...
extern uint8_t Motor_data[Motor_FRAME_LENGTH];
vision_garbage_t vision_garbage;
extern uint8_t up_motor_move_flag;
extern Down_Motor_t Down_Motor;
uint8_t vision_usart_flag;
extern uint8_t screen_usart_flag;
uint8_t garbage_Serial;
/* USER CODE END 0 */
...
void  HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
    ...
    screen_usart_flag=1;
    garbage_Serial++;
    HAL_UART_Receive_DMA(&huart2,&Vision_data[0],Vision_FRAME_LENGTH);
	}
	if(huart->Instance==Motor_USART)
	{
